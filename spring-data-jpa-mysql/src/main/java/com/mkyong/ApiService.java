...
//    private KienHangRepository kienHangRepository;
    ...
    public void login(String login, String password) {
        ...
        WebClient webClient = WebClient.builder()
                .baseUrl("https://nhaphang.alibao.vn")
        ...
        webClient.post()
                ...
                .exchange()
                .flatMap(response -> {
                    // Retrieve and handle the cookies from the response headers
                    HttpHeaders headers = response.headers().asHttpHeaders();
                    List<String> cookieHeaders = headers.get(HttpHeaders.SET_COOKIE);
                    System.out.println("headers: " + headers);
                    System.out.println("Cookies: " + cookieHeaders);
//                    if (cookieHeaders != null) {
//                        for (String cookieHeader : cookieHeaders) {
//                            ResponseCookie cookie = ResponseCookie.parse(cookieHeader).get(0);
//                            // Access the cookie properties as needed
